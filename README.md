...
* **Full dataset:** [Retail Transactions Dataset on Kaggle](https://www.kaggle.com/datasets/prasad22/retail-transactions-dataset?resource=download)

The full dataset contains **1,000,000 transactions across 81 unique products**. The repository includes a smaller sample dataset for quick testing, while the full dataset is linked separately due to its size.
